...
<section class="bienvenida text-center seccion">
 ...
 <section class="instructores">
     <div class="contenedor seccion instructores">
        <h2 class="contenedor seccion instructores"> Nuestros Instructores </h2>
  ...
  <h2 class="text-center texto-blanco"> Testimoniales </h2>
    <div class="contenedor-testimoniales">
       <ul class="listado-testimoniales">
         ...
         ?>
         <li class="testimonial texto-centrado">
           <blockquote>
              <div class="patestimonio"><?php the_content(); ?></div>
           </blockquote>
...
<section class="blog contenedor seccion home">
