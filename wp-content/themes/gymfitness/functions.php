...
function gymfitness_scripts_styles() {
    ...
    wp_enqueue_style('googleFont', 'https://fonts.googleapis.com/css2?family=Open+Sans&family=Raleway&family=Staatliches&display=swap', array(), '1.0.0');
    ...
    if(is_page('contacto')):
        wp_enqueue_script('leaftletJS', 'https://unpkg.com/leaflet@1.7.1/dist/leaflet.js', array('jquery'), '1.7.1', true);
    endif;
